...
public class DeltagerRepositoryImpl implements DeltagerRepositoryCustom {
    ...
    public void bulkWireReferences() {
        ...
        this.entityManager.createNativeQuery("update cvr_deltager deltager inner join cvr_company company on deltager.cvr_nummer=company.cvr_nummer set deltager.company_id=company.id where deltager.company_id=NULL").executeUpdate();
