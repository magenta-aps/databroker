 ...
 */
@Entity
@Table(name = "reserveret_lige_husnr_interval")
public class ReserveretLigeHusnrIntervalEntity {
    private int id;
    ...
    @Column(name = "reserveret_lige_husnr_interval_id", nullable = false, insertable = true, updatable = true)
    public int getId() {
        return id;
    }
    ...
    public boolean equals(Object o) {
        ...
        ReserveretLigeHusnrIntervalEntity that = (ReserveretLigeHusnrIntervalEntity) o;
