...
public class VejModel {
    ...
    public VejModel(CprKommuneRepository kommuneRepository, KommunedelAfNavngivenVejRepository kommunedelAfNavngivenVejRepository, NavngivenVejRepository navngivenVejRepository, RegistreringEntity createRegistrering, RegistreringEntity updateRegistrering) {
    ...
    private void createRoad(VejRegister.AktivVej aktivVej,
                Level1Container<CprKommuneEntity> kommuneCache, Level2Container<KommunedelAfNavngivenVejEntity> kommunedelAfNavngivenVejCache, Level2Container<NavngivenVejEntity> navngivenVejCache,
                EntityModificationCounter navngivenVejCounter, EntityModificationCounter kommunedelAfNavngivenVejCounter) {
        ...
        CprKommuneEntity kommune = kommuneCache.get(kommuneKode);
